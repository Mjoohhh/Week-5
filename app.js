...
playBtn.addEventListener("click", () => {
   ...
   const userChoice = userChoiceMenu.value 
    ...
    if(cpuChoice === userChoice) {
        ...
        output.innerHTML = `Oh no! You lose! Rock beats scissors.`
    } else if (cpuChoice === "paper" && userChoice === "rock") {
        output.innerHTML = `Oh no! You lose! Paper beats rock.`
        ...
        output.innerHTML = `Oh no! You lose! Scissors beats paper.`
